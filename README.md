...
The following environment variables configure Livebook:
  ...
  * LIVEBOOK_SECRET_KEY_BASE - this sets a secret key that is used to sign and encrypt payloads use by Livebook. By default a random one is generated at boot but you can set your own with this environment variable. The secret key base must be at least 64 characters long and it can be generated via commands such as: `openssl rand -base64 48`
