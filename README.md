...
### Desktop app
  ...
  * Nightly builds:
    ...
    [Linux (arm64)](https://github.com/livebook-dev/livebook/releases/download/nightly/Livebook-linux-aarch64.exe),
    [Linux (x64)](https://github.com/livebook-dev/livebook/releases/download/nightly/Livebook-linux-x64.exe)
