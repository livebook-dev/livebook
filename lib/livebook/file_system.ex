defprotocol Livebook.FileSystem do
  ...
  @typedoc """
  A unique identifier generated by the livebook for config storage purposes.

  In case of the local filesystem, the id resolves to a `:local` atom.
  """
  @type id :: String.t() | :local
