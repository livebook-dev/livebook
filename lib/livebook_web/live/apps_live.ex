defmodule LivebookWeb.AppsLive do
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Livebook.Teams.Broadcasts.subscribe([:app_server, :app_deployments, :app_folders])
          ...
          <%= if @apps != [] do %>
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
              <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col md:flex-row gap-4">
                  ...
                  <div class="md:w-48">
                    <form phx-change="select_app_folder" phx-nosubmit>
                      <.select_field
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                <.link
                  :for={app <- Enum.sort_by(apps, & &1.notebook_name)}
                  id={"app-#{app.slug}"}
  ...
  defp filter_by_app_folder(apps, value) when value in ["", "all"], do: apps
