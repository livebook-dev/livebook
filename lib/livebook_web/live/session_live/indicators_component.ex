defmodule LivebookWeb.SessionLive.IndicatorsComponent do
  ...
  defp focus_mode_indicator(assigns) do
    ~H"""
      ...
      <.menu id="focus-mode-menu" position="top-right">
        ...
        <:content>
          <button class="menu-item text-gray-500"
            role="menuitem"
            data-el-code-focus-mode-outputs-toggle>
            <.remix_icon icon="layout-bottom-2-line" />
            <span class="font-medium">Toggle outputs</span>
          </button>
          <button class="menu-item text-gray-500"
            role="menuitem"
            data-el-code-focus-mode-disable-button>
            <.remix_icon icon="close-line" />
            <span class="font-medium">Exit code focus mode</span>
          </button>
        </:content>
      </.menu>
    </div>
