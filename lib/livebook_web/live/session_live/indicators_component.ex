defmodule LivebookWeb.SessionLive.IndicatorsComponent do
  ...
  def nav_render(assigns) do
    ~H"""
    <nav class="sticky top-0 z-40 flex flex-none w-full py-1 mx-auto bg-white border-b border-gray-200">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="flex flex-row items-center space-x-2" data-el-notebook-indicators>
          <.code_zen_indicator />
          <%= if @file do %>
            <%= if @dirty do %>
              <%= if @autosave_interval_s do %>
