defmodule LivebookWeb.SettingsLive.AddEnvironmentVariableComponent do
  ...
  @impl true
  def mount(socket) do
    {:ok, assign(socket, changeset: Settings.change_env_var(%EnvironmentVariable{}))}
  end
  ...
  def handle_event("validate", %{"environment_variable" => attrs}, socket) do
    {:noreply, assign(socket, changeset: Settings.change_env_var(%EnvironmentVariable{}, attrs))}
  end
