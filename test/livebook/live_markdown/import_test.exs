defmodule Livebook.LiveMarkdown.ImportTest do
  ...
  describe "app settings" do
    test "imports settings" do
      markdown = """
      <!-- livebook:{"app_settings":{"access_type":"public","app_folder_id":"123","auto_shutdown_ms":5000,"multi_session":true,"container_type":"full","output_type":"rich","show_existing_sessions":false,"show_source":true,"slug":"app"}} -->
